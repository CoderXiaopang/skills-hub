export const resources = {
  en: {
    translation: {
      ...
      dragDropFolder: 'Drag and drop folder here',
      orClickBrowse: 'or click Browse button',
      preview: {
        title: 'Preview',
        loading: 'Loading SKILL.md...',
        loadFailed: 'Failed to load SKILL.md. Make sure the skill directory contains a SKILL.md file.',
        notAvailableInBrowser: 'Preview is only available in the desktop app.',
        translate: 'Translate to Chinese',
        showOriginal: 'Show Original',
        showTranslated: 'Show Translation',
        llmNotConfigured: 'LLM not configured. Please set API settings in Settings.',
        remarkPlaceholder: 'Add a note...',
        editRemark: 'Edit note',
        replaceOriginal: 'Replace Original',
      },
      llm: {
        sectionTitle: 'AI Translation (OpenAI-compatible)',
        hint: 'Used for translating skill content. Supports any OpenAI-compatible API.',
        baseUrl: 'API Base URL',
        apiKey: 'API Key',
        model: 'Model',
        modelHint: 'e.g. gpt-4o-mini, claude-3-haiku, deepseek-chat',
  ...
  zh: {
    translation: {
      ...
      dragDropFolder: '拖拽文件夹到此处',
      orClickBrowse: '或点击浏览按钮',
      preview: {
        title: '预览',
        loading: '加载 SKILL.md 中...',
        loadFailed: '加载 SKILL.md 失败。请确保 Skill 目录中包含 SKILL.md 文件。',
        notAvailableInBrowser: '预览功能仅在桌面应用中可用。',
        translate: '翻译成中文',
        showOriginal: '查看原文',
        showTranslated: '查看译文',
        llmNotConfigured: 'LLM 未配置，请先在设置中填写 API 信息。',
        remarkPlaceholder: '添加备注...',
        editRemark: '编辑备注',
        replaceOriginal: '替换原文',
      },
      llm: {
        sectionTitle: 'AI 翻译（OpenAI 兼容接口）',
        hint: '用于 Skill 内容翻译，支持 OpenAI 兼容的所有 API。',
        baseUrl: 'API 地址（Base URL）',
        apiKey: 'API Key',
        model: '模型名称',
        modelHint: '例如：gpt-4o-mini、claude-3-haiku、deepseek-chat',
        testConnection: '测试连接',
      },
